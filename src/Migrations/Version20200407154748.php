 ...
 */
final class Version20200407154748 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE nation (id INT AUTO_INCREMENT NOT NULL, ethnie_id INT NOT NULL, leader_id INT NOT NULL, libelle VARCHAR(100) NOT NULL, drapeau LONGTEXT DEFAULT NULL, INDEX IDX_CC5A6D27539A2DA8 (ethnie_id), UNIQUE INDEX UNIQ_CC5A6D2773154ED4 (leader_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE nation_parti (id INT AUTO_INCREMENT NOT NULL, relation_id INT NOT NULL, parti_id INT DEFAULT NULL, popularite DOUBLE PRECISION NOT NULL, INDEX IDX_5914B4883256915B (relation_id), UNIQUE INDEX UNIQ_5914B488712547C6 (parti_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE parti (id INT AUTO_INCREMENT NOT NULL, politique_id INT DEFAULT NULL, libelle VARCHAR(100) NOT NULL, logo LONGTEXT DEFAULT NULL, INDEX IDX_94225E84F528CAF0 (politique_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
